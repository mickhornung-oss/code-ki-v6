...
V5_LAB_MARKER_PATH = CONFIG_DIR / "v5_lab_marker.json"
...
class AppConfig:
    ...
    v4_file_suggestion_limit: int
    v5_lab_enabled: bool = False
...
def _resolve_model_path(config_payload: dict) -> str:
    ...
    candidate_paths = [REPO_ROOT / "models" / "qwen2.5-7b-instruct-q4_k_m.gguf"]
...
def load_config() -> AppConfig:
    ...
    return AppConfig(
        ...
        max_additional_files=int(payload.get("max_additional_files") or 5),
        max_workspace_files=int(payload.get("max_workspace_files") or 200),
        v4_file_suggestion_limit=int(payload.get("v4_file_suggestion_limit") or 6),
        v5_lab_enabled=v5_enabled,
    )
